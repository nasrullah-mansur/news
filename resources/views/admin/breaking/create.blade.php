...
<section id="basic-form-layouts">
    <form action="{{ route('admin.breaking.store') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="pl_breaking_news" class="form-control {{ $errors->has('pl_breaking_news') ? 'is-invalid' : '' }}" placeholder="News Headline (PL)" name="pl_breaking_news" value="{{ old('pl_breaking_news') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="sl_breaking_news" class="form-control {{ $errors->has('sl_breaking_news') ? 'is-invalid' : '' }}" placeholder="News Headline (SL)" name="sl_breaking_news" value="{{ old('sl_breaking_news') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="url" class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" placeholder="News Headline (SL)" name="url" value="{{ old('url') }}">
                            @if ($errors->has('url'))
