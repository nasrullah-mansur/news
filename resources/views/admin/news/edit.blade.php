                ...
                <div class="card-body">
                    <div class="form-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="pl_headline" class="form-control {{ $errors->has('pl_headline') ? 'is-invalid' : '' }}" placeholder="News Headline (PL)" name="pl_headline" value="{{ $news->pl_headline }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="sl_headline" class="form-control {{ $errors->has('sl_headline') ? 'is-invalid' : '' }}" placeholder="News Headline (SL)" name="sl_headline" value="{{ $news->sl_headline }}">
                        ...
                        <textarea id="pl_description" rows="5" class="form-control {{ $errors->has('pl_description') ? 'is-invalid' : '' }}" name="pl_description" placeholder="News Description (PL)">{{ $news->pl_description }}</textarea>
                        ...
                        <textarea id="sl_description" rows="5" class="form-control {{ $errors->has('sl_description') ? 'is-invalid' : '' }}" name="sl_description" placeholder="News Description (SL)">{{ $news->sl_description }}</textarea>
                        ...
                        <textarea id="pl_details" rows="5" class="form-control summernote {{ $errors->has('pl_details') ? 'is-invalid' : '' }}" name="pl_details" placeholder="News Details (PL)">{{ $news->pl_details }}</textarea>
                        ...
                        <textarea id="sl_details" rows="5" class="form-control summernote {{ $errors->has('sl_details') ? 'is-invalid' : '' }}" name="sl_details" placeholder="News Details (SL)">{{ $news->sl_details }}</textarea>
                            ...
                            <div id="seo-content" role="tabpanel" aria-labelledby="seo-content-title" class="collapse">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="pl_seo_title" class="form-control" placeholder="SEO Title (PL)" name="pl_seo_title" value="{{ $news->pl_seo_title }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="sl_seo_title">SEO Title (SL)</label>
                                        <input type="text" id="sl_seo_title" class="form-control" placeholder="SEO Title (SL)" name="sl_seo_title" value="{{ $news->sl_seo_title }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="pl_seo_tag">SEO Tag (PL)</label>
                                        <input type="text" id="pl_seo_tag" class="form-control" placeholder="SEO Tag (PL)" name="pl_seo_tag" value="{{ $news->pl_seo_tag }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="sl_seo_tag">SEO Tag (SL)</label>
                                        <input type="text" id="sl_seo_tag" class="form-control" placeholder="SEO Tag (SL)" name="sl_seo_tag" value="{{ $news->sl_seo_tag }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="pl_description">SEO description (PL)</label>
                                        <textarea id="pl_description" rows="5" class="form-control" name="pl_seo_description" placeholder="SEO description (PL)">{{ $news->pl_seo_description }}</textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="sl_description">SEO description (SL)</label>
                                        <textarea id="sl_description" rows="5" class="form-control" name="sl_seo_description" placeholder="SEO description (SL)">{{ $news->sl_seo_description }}</textarea>
                                    </div>
                                </div>
                                </div>
                            </div>
                ...
                <div class="card-body">
                    <div class="form-body">
                        ...
                        <fieldset class="form-group">
                            ...
                            <input type="text" id="video" class="form-control" placeholder="Video Link" name="video" value="{{ $news->video }}">
                        </fieldset>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="tagging form-control" style="padding: 10px 15px;">{{ str_replace(",",", ", $news->tags) }}</div>
                            @if ($errors->has('tag'))
