            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-body">
                        ...
                        <textarea id="sl_details" rows="5" class="form-control summernote" name="sl_details {{ $errors->has('sl_details') ? 'is-invalid' : '' }}" placeholder="News Details (SL)">{{ $news->sl_details }}</textarea>
