    ...
    <div class="row">
        <div class="col-12">
            <div class="text-right">
                <a href="#" data-toggle="modal" data-target="#add_user" class="btn add-user btn-primary btn-min-width mr-1 mb-1">Add Admin</a>
            </div>
            <div class="card">
...
<div class="modal fade text-left" id="add_user" tabindex="-1" role="dialog" aria-labelledby="add_user_area" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header bg-primary white">
            <h3 class="modal-title" id="add_user_area"> Add New Admin</h3>
        ...
        <form>
            ...
            <button type="button" id="add_user_btn" class="btn btn-outline-primary btn-lg add-category">Save Admin</button>
            </div>
        </form>
        </div>
    </div>
