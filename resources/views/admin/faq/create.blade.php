                ...
                <div class="card-body">
                    <form action="{{ route('admin.faq.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="pl_question" name="pl_question" class="form-control {{ $errors->has('pl_question') ? 'is-invalid' : '' }}" placeholder="Question">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="sl_question" name="sl_question" class="form-control {{ $errors->has('sl_question') ? 'is-invalid' : '' }}" placeholder="Question">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="pl_answer" name="pl_answer" rows="5" class="form-control summernote {{ $errors->has('pl_answer') ? 'is-invalid' : '' }}" placeholder="Answer"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="sl_answer" name="sl_answer" rows="5" class="form-control summernote {{ $errors->has('sl_answer') ? 'is-invalid' : '' }}" placeholder="Answer"></textarea>
