        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Request for add</h4>
...
let table = $(".datatable");
    table.DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.add.request.all') }}",
        columns: [
        ...
        buttons: dataTableBtn('Request for add '),
    });
        ...
        e.preventDefault();
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: "POST",
                        url: `/admin/add-request/add-request/${delteteDataId}/delete`,
